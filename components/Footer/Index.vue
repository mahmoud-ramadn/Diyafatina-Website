<template>
  <div
    class="md:pt-16 relative pt-8 md:pb-12 pb-6 md:mt-28 mt-20 overflow-hidden"
  >
    <img
      src="/assets/images/Ellipse 3.webp"
      alt="left"
      class="absolute left-0 top-0 w-32 md:w-auto"
    />
    <div
    ...
    >
      <div class="w-full md:max-w-[400px]">
        ...
        <div class="flex items-center gap-x-3 mt-6">
          <svg-icon name="facebook.svg" class="size-6" />
          <svg-icon name="x-icon.svg" class="size-6" />
          <svg-icon name="insta.svg" class="size-6" />
        </div>
      </div>
      ...
      <ClientOnly>
        <div class="mt-6 md:mt-0">
          <h3 class="text-gray-600 font-black">وسائل الدفع</h3>
          <div class="flex items-center gap-x-4 mt-6">
            <svg-icon name="visa 1.svg" class="size-12" />
            <svg-icon name="mastercard 1.svg" class="size-12" />
            <svg-icon name="Apple Pay.svg" class="size-12" />
          </div>
        </div>
      </ClientOnly>
      <img
        src="/assets/images/Ellipse 4.webp"
        alt="center"
        class="absolute left-1/2 top-auto hidden md:block"
      />
    </div>
    <div
      class="container border-t border-gray-300 md:border-gray-800 pt-6 flex items-center justify-between flex-wrap gap-4"
    >
      <p class="text-gray-600 font-medium text-sm">
        جميع الحقوق محفوظة © ضيافتنا
      </p>
